...
def main():
	# Set directories -------
	aws_label_dir = "API_Project/AWS-LabelledData-Rescale150"
	gcv_label_dir = "API_Project/GCV-LabelledData-Rescale150"
	img_dir = "ImageData-Rescale150"
	...
	aws_response = aws_Rekognition.label_images(byte_imgs = aws_img_data, img_nums = 200)
